...
static const char col_cyan[]        = "#689d68";
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,		XK_Up,     spawn,	   SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +10%") },
	{ MODKEY|ControlMask,		XK_Down,   spawn,	   SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -10%") },
};
